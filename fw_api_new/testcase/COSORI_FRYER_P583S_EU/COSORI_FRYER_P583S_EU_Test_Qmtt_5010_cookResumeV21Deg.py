...
comDataStr = '{"context":{"traceId":"[0-9]*","method":"cookResumeV2".*?"cookLastTime":.*?}}'
...
class cosoriTest(unittest.TestCase):
    ...
    def cookstartQmtt(self, mode=exceptMode, recipeId=exceptRecipeId, cookTemp=exceptTestDegval, cookTime=exceptTestTime, testUnit=exceptDegUnit):
        """
        {'context': {'traceId': '1624937394902', 'method': 'cookStartV2', 'pid': 'v8w4b6hyvzj74ki1', 'cid': 'vssk1322d4864f0f800134db9b2080b5', 'deviceRegion': 'US'},
        'data': {'accountId': '1516480', 'recipeId': 4, 'recipeType': 3, 'cookStartTime': 1624937394, 'workTime': 1800, 'workTemp': 180, 'mode': 'Bake', 'level': 4, 'workTempUnit': 'f', 'hasPreheat': 0}}
        """
        ...
        try:
            ...
            print("======resumeWorkRes=========")
            resumeWorkRes = commonFunc().commMethodApi(method="resumeWork")
            time.sleep(60)
            ...
            print("=====异常=====", e)
            resCook = commonFunc().commMethodApiNew(method="startCook", mode=mode, recipeId=recipeId, cookTemp=cookTemp,
                                                    cookTime=cookTime, unit=testUnit)
    ...
    def testqmttfah(self):
        ...
        try:
            print(testComData)
            if testComData["data"]["resumeTime"] and testComData["data"]["cookLastTime"] and testComData["context"]["cause"]:
