...
comDataStr = '{"context":{"traceId":"[0-9]*","method":"cookPauseV2".*?"changeReason":.*?}}'
...
class cosoriTest(unittest.TestCase):
    ...
    def testqmttfah(self):
        ...
        try:
            print(testComData)
            if testComData["data"]["cookLastTime"] and testComData["data"]["pauseStartTime"] and testComData["data"]["changeReason"] and testComData["context"]["cause"]:
