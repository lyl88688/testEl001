...
#全局变量
pluginNameMcu = globalName.pluginNameMcu
newVersionMcu = globalName.newVersionMcu
newVersionUrlMcu = globalName.newVersionUrlMcu
pluginNameMainFw = globalName.pluginNameMainFw
newVersionMainFw = globalName.newVersionMainFw
newVersionUrlMainFw = globalName.newVersionUrlMainFw

i = 0
updateOldMainFwInfo = []
updateOldMcuInfo = []
while i < int(globalName.updateTime):
    i += 1
    updateOldMcu = []
    updateOldMainFw = []
    if i <= int(globalName.updateTime):
        updateOldMcu.append(globalName.oldVersionMcu)
        updateOldMcu.append(globalName.oldVersionUrlMcu)
        updateOldMainFw.append(globalName.oldVersionMainFw)
        updateOldMainFw.append(globalName.oldVersionUrlMainFw)
