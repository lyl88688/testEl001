...
cookStartVal = [["AirFry", 6, 150,1800],
                ...
                ["Pizza", 3, 190, 1800],
                ["Roast", 5, 200, 1800],
                ["SlowCook", 14, 210,1800]]

#cookStartValTaost = ["Toast", 1, 480, 275, 5] ["Dehydrate", 10, 100, 1800],["Fermentation", 11, 80,1800]#不支持预热


#需要匹配的串口字符串变量，来源Qmtt协议。
comDataStr = '{"context":{"traceId":"[0-9]*","method":"preheatStartV2".*?"preheatTempUnit":.*?}}'
