...
class MyWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        labelA = QtWidgets.QLabel("Name")
        lineEditB = QtWidgets.QLineEdit("name")
        lineEditD = QtWidgets.QLineEdit("age")
        buttonC = QtWidgets.QPushButton("Submit")


        hlayout.addWidget(labelA)  # 局部布局添加部件（例如：按钮）
        hlayout.addWidget(lineEditB)
        vlayout.addWidget(lineEditD)
